return {
  {
    ...
    config = function()
      ...
      require('dap-python').setup '/home/smitty/.local/share/nvim/mason/packages/debugpy/venv/bin/python'
      ...
      vim.keymap.set('n', '<space>gb', dap.run_to_cursor, { desc = 'Run Debugger Into Cursor' })
